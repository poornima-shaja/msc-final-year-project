...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\veathavalli\Desktop\projectFlask\env'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\veathavalli\Desktop\projectFlask\env\Scripts\deactivate.nu'
